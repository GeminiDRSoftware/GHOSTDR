...
#                                                              listPrimitives.py
# ------------------------------------------------------------------------------
# $Id: listprimitives.py 5219 2015-04-15 00:05:34Z klabrie $
# ------------------------------------------------------------------------------
__version__      = '$Revision: 5219 $'[11:-2]
__version_date__ = '$Date: 2015-04-14 14:05:34 -1000 (Tue, 14 Apr 2015) $'[7:-2]
# ------------------------------------------------------------------------------
import os
import sys
