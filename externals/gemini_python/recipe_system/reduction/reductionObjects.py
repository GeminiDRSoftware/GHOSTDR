...
#                                                            ReductionObjects.py
# ------------------------------------------------------------------------------
# $Id: reductionObjects.py 5473 2016-01-06 17:02:14Z kanderson $
# ------------------------------------------------------------------------------
__version__      = '$Revision: 5473 $'[11:-2]
__version_date__ = '$Date: 2016-01-07 04:02:14 +1100 (Thu, 07 Jan 2016) $'[7:-2]
# ------------------------------------------------------------------------------
import re 
import os
import gc
