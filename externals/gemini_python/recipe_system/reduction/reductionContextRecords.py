...
#                                                     reductionContextRecords.py
# ------------------------------------------------------------------------------
# $Id: reductionContextRecords.py 5142 2015-02-17 21:39:45Z kanderson $
# ------------------------------------------------------------------------------
...
class ReductionContextRecord(object):
    """
    The parent record. Contains all members global to all records. 
    (i.e. timestamp)
    """
    timestamp = None
...
##@@FIXME: Because of the nature of how Output -> Input, the name of this record 
...
class AstroDataRecord( ReductionContextRecord ):
    ...
    def __init__(self, filename, display_id=None, timestamp=None, parent=None, 
                 load = True):
