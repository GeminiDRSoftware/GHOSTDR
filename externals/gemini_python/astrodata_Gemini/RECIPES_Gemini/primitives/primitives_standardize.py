...
#                                                                        08-2013
# ------------------------------------------------------------------------------
# $Id: primitives_standardize.py 5553 2016-02-04 19:13:53Z edown $
# ------------------------------------------------------------------------------
__version__      = '$Revision: 5553 $'[11:-2]
__version_date__ = '$Date: 2016-02-04 09:13:53 -1000 (Thu, 04 Feb 2016) $'[7:-2]
# ------------------------------------------------------------------------------
import os
import numpy as np
