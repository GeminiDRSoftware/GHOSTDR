...
class TestSlitArc(object):
    ...
    @pytest.fixture
    def do_slit(self, get_or_create_tmpdir):
        """
    ...
    def test_slit_bias_done(self, do_slit):
        """
        Check that bias subtraction was actually performed
        """

        rawfiles, corrfile, calibs = do_slit
    ...
    def test_slit_dark_done(self, do_slit):
        """
        ...
        assert corrflat.phu.get('DARKCORR'), "No record of dark correction " \
                                             "having been performed on {} " \
                                             "(PHU keyword BIASCORR " \
                                             "missing)".format(corrfile)
    ...
    def test_slit_procslit_done(self, do_slit):
        """
        Check that dark correction was actually performed
        """
